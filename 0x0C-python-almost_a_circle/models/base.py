...
class Base:
    ...
    def to_json_string(list_dictionaries):
        """it returns the JSON string representation of a list of dictionaries"""
    ...
    def save_to_file_csv(cls, list_objs):
        """it serializes a list of Rectangles/Squares in csv"""
    ...
    def load_from_file_csv(cls):
        """it deserializes a list of Rectangles/Squares in csv"""
        filename = cls.__name__ + ".csv"
        l = []
        try:
