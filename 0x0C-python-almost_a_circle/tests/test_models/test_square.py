...
class TestSquareDocs(unittest.TestCase):
    ...
    def test_pep8_conformance_square(self):
        """Tests that models/square.py conforms to PEP8."""
...
class TestSquare(unittest.TestCase):
    ...
    def test_mandatory_size(self):
        """Tests that width is a mandatory arg"""
        with self.assertRaises(TypeError):
            s = Square()

    def test_size_typeerror(self):
        """Tests non-ints for size"""
    ...
    def test_display_too_many_args(self):
        """Tests display with too many args"""
        with self.assertRaises(TypeError):
            self.s1.display(1)
    ...
    def test_update_too_many_args(self):
        """tests too many args for update"""
        s = Square(1, 0, 0, 1)
        s.update(1, 1, 1, 1, 2)
    ...
    def test_update_kwargs(self):
        """it tests the update method with **kwargs"""
        s = Square(1, 0, 0, 1)
        self.assertEqual(str(s), "[Square] (1) 0/0 - 1")
        s.update(size=10)
    ...
    def test_load_from_file(self):
        """tests normal use of load_from_file"""
        s1 = Square(2, 3, 4, 5)
        s2 = Square(7, 8, 9, 10)
        li = [s1, s2]
