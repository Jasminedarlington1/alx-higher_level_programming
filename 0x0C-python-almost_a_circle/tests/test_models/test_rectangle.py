...
class TestRectangleDocs(unittest.TestCase):
    """it tests the Rectangle class' style and documentation"""
    @classmethod
    def setUpClass(cls):
    ...
    def test_pep8_conformance_rectangle(self):
        """Tests that models/rectangle.py conforms to PEP8."""
...
class TestRectangle(unittest.TestCase):
    ...
    def test_basic_display(self):
        """it Tests display without x and y"""
    ...
    def test_display_too_many_args(self):
        """it tests display with too many args"""
        with self.assertRaises(TypeError):
            self.r1.display(1)

    def test_str(self):
        """it tests the __str__ method"""
    ...
    def test_update_args(self):
        """it Tests the udpate method with *args"""
    ...
    def test_update_args_setter(self):
        """it tests that the update method uses setter with *args"""
        r = Rectangle(1, 1, 0, 0, 1)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            r.update(1, "hello")
        with self.assertRaisesRegex(TypeError, "height must be an integer"):
    ...
    def test_update_kwargs_setter(self):
        """it tests that the update method uses setter with **kwargs"""
    ...
    def test_save_to_file(self):
        """it tests regular use of save_to_file"""
    ...
    def test_stf_empty(self):
        """it tests save_to_file with empty list"""
        l = []
        Rectangle.save_to_file(l)
        with open("Rectangle.json", "r") as f:
    ...
    def test_stf_None(self):
        """it tests save_to_file with None"""
        Rectangle.save_to_file(None)
        with open("Rectangle.json", "r") as f:
            self.assertEqual("[]", f.read())

    def test_create(self):
        """it tests normal use of create"""
    ...
    def test_load_from_file_no_file(self):
        """it checks use of load_from_file with no file"""
        try:
    ...
    def test_load_from_file_empty_file(self):
        """it checks use of load_from_file with empty file"""
        try:
            os.remove("Rectangle.json")
        except:
            pass
    ...
    def test_load_from_file(self):
        """it tests normal use of load_from_file"""
